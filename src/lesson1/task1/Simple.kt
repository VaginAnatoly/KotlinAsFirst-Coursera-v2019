 ...
 * десятичная форма градусов = градусы + (минуты + секунды/60)/60»
 * радиан = градусы * Пи/180
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double {


    val graduce = deg + (min /60.0) + (sec/3600.0)
    println("Градусов в десятичном измерении: $graduce")
    val returnRadian = graduce * (Math.PI/180)
    return returnRadian
}
/**
 * Тривиальная
...
fun thirdDigit(number: Int): Int {
    val digit : Double = ((number / Math.pow(10.0, 3.0 - 1)) % 10.0)
    return(digit.toInt())
}
